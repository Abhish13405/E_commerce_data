...
# # ---------------------------------------------------------
# st.set_page_config(
#     page_title="Ecommerce Sales Dashboard", page_icon="🛒", layout="wide"
# )
...
if "prediction" in st.session_state:
    ...
    comparison_df = cust_summary_full[
        ["CustomerID", "NumOrders", "AvgOrderValue", "TotalSpent"]
    ].copy()
